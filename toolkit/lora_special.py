...
class LoRASpecialNetwork(ToolkitNetworkMixin, LoRANetwork):
    ...
    def __init__(
        ...
        # print("==== Injected LoRA Modules ====")
        # for lora in self.unet_loras:
        #     print(f"Name: {lora.lora_name}")
        # exit()
    ...
    def set_restore_grad(self):
        # with open("lora_names.txt", "w") as f:
        for lora in self.unet_loras:
            name = lora.lora_name
            # f.write(name + "\n")
            is_target = name in self.restore_keywords
    ...
    def set_transfer_grad(self):
        ...
        for lora in self.unet_loras:
            name = lora.lora_name
            is_target = not (name in self.restore_keywords)
            if is_target:
                # print("true")
                num+=1
            else:
